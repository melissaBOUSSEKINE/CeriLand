...
public class CommandEnvoyeController implements Initializable {
    ...
    void buildObjectCards(int nombreObjects, ArrayList<Object> objects, boolean showAddButton, boolean showdeleteButton){
        ...
        for (int i = 0; i < nombreObjects; i++) {
            ObejctCard obejctCard = new ObejctCard(objects.get(i), imageHashMap.get(objects.get(i).getImgUrl()), false, false, cardGrid);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        commands = ApiService.getCommandsSentByCommanderId(VarGlobal.currentUser.getId());
        ...
        this.buildObjectCards(commands.size(), objects, false, false);
    }
}
